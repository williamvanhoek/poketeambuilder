...
const pokemonList = [
    ...
    { number: "0453", name: "Croagunk", types: ["Poison", "Fighting"] },
    { number: "0454", name: "Toxicroak", types: ["Poison", "Fighting"] },
    { number: "0455", name: "Carnivine", types: ["Grass"] },
    { number: "0456", name: "Finneon", types: ["Water"] },
    { number: "0457", name: "Lumineon", types: ["Water"] },
    { number: "0458", name: "Mantyke", types: ["Water", "Flying"] },
    { number: "0459", name: "Snover", types: ["Grass", "Ice"] },
    { number: "0460", name: "Abomasnow", types: ["Grass", "Ice"] },
    { number: "0461", name: "Weavile", types: ["Dark", "Ice"] },
    { number: "0462", name: "Magnezone", types: ["Electric", "Steel"] },
    { number: "0463", name: "Lickilicky", types: ["Normal"] },
    { number: "0464", name: "Rhyperior", types: ["Ground", "Rock"] },
    { number: "0465", name: "Tangrowth", types: ["Grass"] },
    { number: "0466", name: "Electivire", types: ["Electric"] },
    { number: "0467", name: "Magmortar", types: ["Fire"] },
    { number: "0468", name: "Togekiss", types: ["Fairy", "Flying"] },
    { number: "0469", name: "Yanmega", types: ["Bug", "Flying"] },
    { number: "0470", name: "Leafeon", types: ["Grass"] },
    { number: "0471", name: "Glaceon", types: ["Ice"] },
    { number: "0472", name: "Gliscor", types: ["Ground", "Flying"] },
    { number: "0473", name: "Mamoswine", types: ["Ice", "Ground"] },
    { number: "0474", name: "Porygon-Z", types: ["Normal"] },
    { number: "0475", name: "Gallade", types: ["Psychic", "Fighting"] },
    { number: "0476", name: "Probopass", types: ["Rock", "Steel"] },
    { number: "0477", name: "Dusknoir", types: ["Ghost"] },
    { number: "0478", name: "Froslass", types: ["Ice", "Ghost"] },
    { number: "0479", name: "Rotom", types: ["Electric", "Ghost"] },
    { number: "0480", name: "Uxie", types: ["Psychic"] },
    { number: "0481", name: "Mesprit", types: ["Psychic"] },
    { number: "0482", name: "Azelf", types: ["Psychic"] },
    { number: "0483", name: "Dialga", types: ["Steel", "Dragon"] },
    { number: "0484", name: "Palkia", types: ["Water", "Dragon"] },
    { number: "0485", name: "Heatran", types: ["Fire", "Steel"] },
    { number: "0486", name: "Regigigas", types: ["Normal"] },
    { number: "0487", name: "Giratina", types: ["Ghost", "Dragon"] },
    { number: "0488", name: "Cresselia", types: ["Psychic"] },
    { number: "0489", name: "Phione", types: ["Water"] },
    { number: "0490", name: "Manaphy", types: ["Water"] },
    { number: "0491", name: "Darkrai", types: ["Dark"] },
    { number: "0492", name: "Shaymin", types: ["Grass"] },
    { number: "0493", name: "Arceus", types: ["Normal"] },
];

// Define type chart with strengths and weaknesses
const typeChart = {
    "Normal": { strongAgainst: [], weakAgainst: ["Fighting"] },
    "Fire": { strongAgainst: ["Grass", "Bug", "Ice", "Steel"], weakAgainst: ["Water", "Rock", "Dragon"] },
    "Water": { strongAgainst: ["Fire", "Ground", "Rock"], weakAgainst: ["Grass", "Dragon"] },
    "Electric": { strongAgainst: ["Water", "Flying"], weakAgainst: ["Ground", "Grass", "Dragon"] },
    "Grass": { strongAgainst: ["Water", "Ground", "Rock"], weakAgainst: ["Fire", "Poison", "Flying", "Bug", "Dragon", "Steel"] },
    "Ice": { strongAgainst: ["Grass", "Ground", "Flying", "Dragon"], weakAgainst: ["Fire", "Water", "Steel"] },
    "Fighting": { strongAgainst: ["Normal", "Rock", "Steel", "Ice", "Dark"], weakAgainst: ["Flying", "Psychic", "Fairy"] },
    "Poison": { strongAgainst: ["Grass", "Fairy"], weakAgainst: ["Ground", "Rock", "Ghost"] },
    ...
    "Psychic": { strongAgainst: ["Fighting", "Poison"], weakAgainst: ["Steel", "Dark"] },
    ...
    "Ghost": { strongAgainst: ["Psychic", "Ghost"], weakAgainst: ["Dark", "Ghost"] },
    "Dragon": { strongAgainst: ["Dragon"], weakAgainst: ["Ice", "Fairy", "Dragon"] },
